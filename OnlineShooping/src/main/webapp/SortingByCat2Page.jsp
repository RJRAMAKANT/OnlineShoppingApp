...
<%ArrayList<ProductBean>all=(ArrayList<ProductBean>)session.getAttribute("sortbycat2"); %>
 ...
 <input type="hidden" id="status" value="<%=request.getAttribute("status")%>">
    ...
    <section>
        <div class="admindashboard mt-1 ">
           <div class="adminsidebar text-center text-dark mt-1 " >
           <div class="m-3 haeel">
           <form action="sortingbycat2" method="post">
           <input type="hidden" value="" name="cata2" id="input">
           <select name="select2">
           <option value="asc">ACCENDING</option>
           <option value="desc">DESSENDING</option>
           </select>
           <input class="sortbottm" type="submit" value="SORT">
            </form>
           </div>
           
           <a href="shopcat2?cat2=mshirt" > <div class="m-3 haeel">MAN SHIRT</div></a>
          <a href="shopcat2?cat2=mjeans" ><div  class="m-3 haeel">MAN JEANS</div></a>
           <a href="shopcat2?cat2=mhoodie" >  <div class="m-3 haeel">MAN HOODIE</div></a>
          <a href="shopcat2?cat2=mtshirt" >  <div class="m-3 haeel">MAN T-SHIRT</div></a>
          <a href="shopcat2?cat2=mfootwear" ><div class="m-3 haeel">SHOOES</div> </a>
           <a href="shopcat2?cat2=wtopwear" > <div  class="m-3 haeel">WOMEN T-SHIRT</div></a>
           <a href="shopcat2?cat2=wkurti" >   <div class="m-3 haeel">WOMEN KURTI</div></a>
           <a href="shopcat2?cat2=wjeans" > <div class="m-3 haeel">WOMEN JEANS</div></a>
           <a href="shopcat2?cat2=wsaree" > <div  class="m-3 haeel">WOMEN SHAREE</div></a>
            
          <a href="shopcat2?cat2=kshirt" >   <div  class="m-3 haeel">BOY SHIRT</div></a>
           <a href="shopcat2?cat2=kpants" >   <div class="m-3 haeel"> JEANS</div></a>
           <a href="shopcat2?cat2=kdress" > <div class="m-3 haeel">GIRL DRESS</div></a>
            
            <a href="shopcat2?cat2=mobile" >   <div  class="m-3 haeel">MOBILE</div></a>
            <a href="shopcat2?cat2=laptop" >  <div class="m-3 haeel">LAPTOP</div></a>
          <a href="shopcat2?cat2=desktop" >  <div class="m-3 haeel">DESKTOP</div></a>
            <a href="shopcat2?cat2=tv" >   <div  class="m-3 haeel">TV</div></a>
     ...
     <input type="hidden" value="<%=cata2%>" id="cata">
