...
<%   UserBean ub=(UserBean)session.getAttribute("edituser"); 
%>
<input type="hidden" id="status" value="<%=request.getAttribute("status") %>">
    ...
    <nav class="d-flex aligen-item-center justify-content-around bg-dark-subtle head w-100">
        <div>
         <a href="UserPage.jsp "><img src="IMAGES/buy1.png" width="100px" height="100px"></a>
        </div>
   ...
   <section>
    <div class=" d-flex justify-content-center align-items-center mt-5 ">
        ...
        <div class="w-25 lform">
            <form class="m-lg-2 " action="edituserpassword" method="post">
                <div class="text-center mb-3 formuserheading">UPDATE PROFILE</div>
                <div class="mb-2 ">
                  <label for="name" class="form-label"> NAME</label>
                  <input type="text" class="form-control" id="name" value=<%=ub.getFname() %> name="Name" readonly >
                </div>
                <div class="mb-2 ">
                    <label for="email" class="form-label">EMAIL</label>
                    <input type="email" class="form-control" id="email" value=<%=ub.getEmail() %> name="Mail" readonly>
                  </div>
                  <div class="mb-2 ">
                    <label for="number" class="form-label">PHONE</label>
                    <input type="NUMBER" class="form-control" id="number1" name="Phone" placeholder="ENTER YOUR PHONE NUMBER" onblur="myFunction()">
                  </div>
                 <%mobile= %><%ub.getPhone() ;%>
                 <%Apassword =%><%ub.getPassword(); %>
                 
               
                 <input type="hidden" value="<%=mobile %>" name="phonenumber2">
                ...
                <div class="mb-3 newpassword" id="newpass">
                  ...
                  <input type="password" class="form-control" id="password2" name="pass1" placeholder="ENTER New PASSWORD"  onblur="myFunction2()"  required>
                </div>
