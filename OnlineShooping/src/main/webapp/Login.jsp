...
<body class="container-fluid" onload="loaded()" id="body">
    <div class="headeron ">
  ...
  <%--<section style="background-color: rgba(4, 103, 70, 0.674);"> --%> 
    ...
    <div class=" d-flex justify-content-center align-items-center">
        <div class=" lform mt-5 w-25 h-50 p-5 mb-5">
            <form style="border-radius: 2px solid gray;" action="userlogin" method="post">
                <div class="text-center mb-3 formuserheading" style="color: black; font-weight: bold; font-family: Georgia">USER LOGIN</div>
                <div class="mb-3 ">
                ...
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control" id="password" name="password">
                    ...
                    <div class="mb-3 randominput">
                       <input type="number" id="randomnum" readonly name="random1">
                    </div>
                    <div class=" mb-3">
                        <input type="number"placeholder="Enter above Captcha" class="form-control" name="random2" required>
              ...
              <div class="mt-2 text-center linka">New User ?&nbsp;<a href="UserSignup.jsp">Register</a> here</div>
...
<div class="ffooter d-flex justify-content-around mt-5 ">
 ...
 <div class="ftrcopy d-flex justify-content-around">
    ...
    <div class="ftrcopy1 d-flex pb-2 ">
        ...
        if(Status=="wrong")
        	{
        	swal("Sorry","Wrong Captcha","error");
        	}
        if(Status=="wrongp")
        	{
