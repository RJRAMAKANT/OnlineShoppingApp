...
<% ArrayList<UserBean> all= (ArrayList<UserBean>)session.getAttribute("user");
 ...
 <input type="hidden" id="status" value="<%=request.getAttribute("status") %>">
   ...
   <section>
    <table class="table table-dark table-striped">
        ...
        <thead>
           ...
           <% UserBean ub1=(UserBean)all.get(i); %>
             ...
             <td><a href="remove?cid=<%=ub1.getCid() %>" class="btn btn-danger">REMOVE</a></td>
           </tr>
    ...
    <footer class="mt-5">
        ...
        if(status=="removed")
        	{
        	swal("REMOVED","USER REMOVED SUCCESSFULLY","error");
        	}
        </script>
