...
<% ArrayList<ProductBean> all= (ArrayList<ProductBean>)session.getAttribute("pb");
    ...
    <table class="table table-dark table-striped">
        ...
        <thead>
           ...
           <% ProductBean pb=(ProductBean)all.get(i); %>
             ...
             <td><%=pb.getPrice() %></td>
             <td><%=pb.getPcatagori1() %></td>
             <td><%=pb.getPcatagorie2() %></td>
             <td><img src="product/<%=pb.getImage1() %>" width="80px" height="80px"></td>
             <td><a href="removep?pid=<%=pb.getPid() %>" class="btn btn-danger">REMOVE</a></td>
           </tr>
